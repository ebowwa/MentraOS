...
import {reportThemeProviderIssue, reportThemePreferenceLoadFailure} from "@/reporting/domains"
...
const setImperativeTheming = async (theme: Theme) => {
  ...
  if (Platform.OS === "android") {
    try {
      ...
      reportWarning("Failed to set navigation bar color", "theme.navigation", "set_nav_bar_color", {
