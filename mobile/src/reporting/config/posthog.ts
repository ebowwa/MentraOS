...
export const getPostHogApiKey = (): string | undefined => {
  return process.env[POSTHOG_API_KEY_KEY] || process.env.EXPO_PUBLIC_POSTHOG_API_KEY || undefined
}
...
export const getPostHogHost = (): string => {
  return process.env[POSTHOG_HOST_KEY] || process.env.EXPO_PUBLIC_POSTHOG_HOST || "https://app.posthog.com"
}
...
export const isPostHogEnabled = (): boolean => {
  const enabled = process.env[POSTHOG_ENABLED_KEY] || process.env.EXPO_PUBLIC_POSTHOG_ENABLED || "false"
