...
export const reportLocationServicesDialogFailure = (reason: string, exception?: Error): void => {
  reportError("Error showing location services dialog", "settings.navigation", "show_location_dialog", exception, {
    reason,
  })
}
 ...
 */
export const reportRequirementSettingsNavigationFailure = (
  requirement: string,
  reason: string,
  exception?: Error,
): void => {
