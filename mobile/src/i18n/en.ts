const en = {
  deviceSettings: {
    ...
    micPhoneInternal: "Phone Microphone",
    micPhoneInternalDesc: "Uses phone's internal microphone",
    micGlassesCustom: "Glasses Microphone",
    micGlassesCustomDesc: "Uses glasses' custom BLE/LC3 microphone",
    micBluetoothClassic: "Bluetooth Microphone",
    micBluetoothClassicDesc: "External Bluetooth Classic HFP mic (for lapel mics)",
