...
const RESOLUTION_OPTIONS: { label: string; value: MetaStreamingResolution; dimensions: string }[] = [
    { label: "Low", value: "low", dimensions: "360×640" },
    { label: "Medium", value: "medium", dimensions: "504×896" },
    { label: "High", value: "high", dimensions: "720×1280" },
]
                ...
                <View style={themed($optionsRow)}>
                    {RESOLUTION_OPTIONS.map((option) => (
                        <TouchableOpacity
                            ...
                            style={[
                                themed($optionButton),
                                resolution === option.value && themed($optionButtonSelected),
                            ]}
                        ...
                        >
                            <Text
                                style={[
                                    themed($optionText),
                                    resolution === option.value && themed($optionTextSelected),
                                ]}
                                text={option.label}
                            />
                            <Text
                                style={[
                                    themed($optionSubtext),
                                    resolution === option.value && themed($optionSubtextSelected),
                                ]}
                ...
                <View style={themed($optionsRow)}>
                    {FPS_OPTIONS.map((option) => (
                        <TouchableOpacity
                            ...
                            style={[
                                themed($optionButton),
                                fps === option.value && themed($optionButtonSelected),
                            ]}
                        ...
                        >
                            <Text
                                style={[
                                    themed($optionText),
                                    fps === option.value && themed($optionTextSelected),
                                ]}
                                text={option.label}
                            />
                        </TouchableOpacity>
