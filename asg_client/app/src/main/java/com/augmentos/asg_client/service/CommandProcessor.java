...
public class CommandProcessor {
    ...
    private void handleStartRtmpStream(JSONObject data) {
        ...
        if (com.augmentos.asg_client.streaming.RtmpStreamingService.isStreaming()) {
            com.augmentos.asg_client.streaming.RtmpStreamingService.stopStreaming(context);
            try {
                Thread.sleep(500);
        ...
        com.augmentos.asg_client.streaming.RtmpStreamingService.startStreaming(context, rtmpUrl, streamId);
    }
