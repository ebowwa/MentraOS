---
title: "Example Apps"
description: "Explore ready-to-run MentraOS example applications for HUD and camera-only smart glasses. Choose a starting point to learn features like live captions, layouts, bitmap graphics, camera capture, TTS, and adaptive capabilities."
---
...
These examples work with smart glasses that have a heads-up display (HUD), such as Even Realities G1 and Mentra Live.
