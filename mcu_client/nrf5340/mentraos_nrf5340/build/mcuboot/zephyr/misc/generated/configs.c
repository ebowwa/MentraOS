...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_NRF_CLEANUP_NONSECURE_RAM, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOT_FIH_PROFILE_LOW, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOT_FIH_PROFILE_DEFAULT_LOW, 1);
