...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NPM1300_LED_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZEPHYR_CUSTOM_HLS12VGA_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NCS_SAMPLE_MCUMGR_BT_OTA_DFU_BACKEND_MCUBOOT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IMG_ERASE_PROGRESSIVELY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_GRP_OS_MCUMGR_PARAMS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_GRP_ZBASIC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_GRP_ZBASIC_STORAGE_ERASE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CONN_TX_MAX, 7);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_TX_BUF_COUNT, 7);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_L2CAP_TX_FRAG_COUNT, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_ATT_TX_COUNT, 7);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DEVICE_APPEARANCE, 448);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CPU_LOAD_USE_SHARED_DPPI_CHANNELS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CPU_LOAD_TIMER_2, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CPU_LOAD_TIMER_INSTANCE, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_EXTERNAL_FLASH_SIZE_BITS, 33554432);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_USE_ALL_AVAILABLE_RAM, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TFM_NFCT_PINS_AS_GPIOS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_FONT_MONTSERRAT_24, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_FONT_MONTSERRAT_26, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_USE_DEMO_WIDGETS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_USE_DEMO_BENCHMARK, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CUSTOM_HLS12VGA, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CUSTOM_HLS12VGA_INIT_PRIORITY, 60);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CUSTOM_HLS12VGA_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_Z_MEM_POOL_SIZE, 102400);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAIN_THREAD_PRIORITY, 14);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LED_NPM1300, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_UPDATE_FOOTER_SIZE, 0x1000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FS_LITTLEFS_READ_SIZE, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FS_LITTLEFS_PROG_SIZE, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FS_LITTLEFS_CACHE_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FS_LITTLEFS_LOOKAHEAD_SIZE, 64);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_GRP_IMG_ALLOW_ERASE_PENDING, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_GRP_ZBASIC_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_GRP_ZBASIC_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_Z_DEMO_BENCHMARK, 1);
