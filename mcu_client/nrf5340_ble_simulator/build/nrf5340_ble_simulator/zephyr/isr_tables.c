...
struct _isr_table_entry __sw_isr_table _sw_isr_table[69] = {
	...
	{(const void *)0x1de9d, (ISR)0x280fb}, /* 33 */
	{(const void *)0x1dead, (ISR)0x280fb}, /* 34 */
