...
const OrganizationSettings: React.FC = () => {
    ...
    const createPersonalOrg = async () => {
      if (!currentOrg && !orgLoading && !isCreatingOrg) {
        ...
        try {
          ...
          toast.error(
            "Failed to create a personal organization. Please try again.",
          );
        } finally {
  ...
  const validateForm = () => {
    ...
    if (
      ...
      formData.profile.contactEmail.trim() === ""
    ) {
              ...
              {isCreatingOrg ? (
                <div className="flex flex-col items-center justify-center p-6">
                  ...
                  <p className="text-muted-foreground">
                    Creating your personal organization...
                  </p>
                </div>
              ) : (
                <Alert variant="destructive">
                  ...
                  <AlertDescription>
                    You don't have an active organization. Please wait while we
                    create one for you.
                  </AlertDescription>
                </Alert>
              )}
      ...
      <div className="max-w-3xl mx-auto">
              ...
              <div className="flex flex-col gap-2 text-sm text-green-700">
                ...
                <div className="mt-3 p-3 bg-green-100 rounded-md">
                  <p className="text-sm text-green-800">
                    💡 <strong>Tip:</strong> You can switch between different
                    organizations you're a member of using the dropdown in the
        ...
        <Card className="shadow-sm mb-6">
          <CardHeader>
            ...
            <CardDescription>
              Select which organization you want to manage. You can switch
              between organizations you're a member of or create a new one.
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2 mt-4">
                  ...
                  <p className="text-xs text-gray-500">
                    The name of your organization that will be displayed to
                    users. Required to publish apps.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-gray-500">
                    An email address where users can contact you for support or
                    inquiries. Required to publish apps.
                  </p>
                </div>
