...
const Members: React.FC = () => {
  ...
  const handleLeaveOrganization = async () => {
    ...
    if (currentUserMember.role === "admin" && !hasOtherAdmins()) {
      toast.error(
        "You cannot leave the organization as you are the only admin. Please promote another member to admin first.",
      );
      return;
    }
  ...
  const handleRescindInvite = async (email: string) => {
    ...
    if (
      !confirm(`Are you sure you want to cancel the invitation to ${email}?`)
    ) {
      return;
    }
          ...
          <Card className="shadow-sm">
            ...
            <CardContent>
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  You don't have an active organization. Please create or join
                              ...
                              <div>
                                ...
                                <div className="text-xs text-gray-500">
                                  {invite.emailSentCount > 1 &&
                                    `Resent ${invite.emailSentCount - 1} time${invite.emailSentCount > 2 ? "s" : ""}`}
                              ...
                              <TableCell className="text-right">
                                <div className="flex justify-end gap-2">
                                  ...
                                  <Button
                                    ...
                                    size="sm"
                                    onClick={() =>
                                      handleRescindInvite(invite.email)
                                    }
                                  >
                                    Cancel
                                  </Button>
              ...
              <form onSubmit={handleInvite} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500">
                    {inviteRole === "admin" &&
                      "Admins have full control over the organization, including managing members and apps."}
                    {inviteRole === "member" &&
                      "Members can manage apps, but cannot manage the organization or its members."}
                  </p>
                </div>
