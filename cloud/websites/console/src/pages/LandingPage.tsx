      ...
      <section className="py-20 bg-gradient-to-b from-white to-gray-100 my-0 flex items-center">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-10 max-w-3xl mx-auto">
            Build and deploy your own apps for smart glasses in minutes, not
            months.
          </p>
          ...
          <div className="mt-4 flex items-center justify-center">
            <Link
              to="https://github.com/Mentra-Community/MentraOS"
              className="flex items-center gap-2 mb-2 px-6 py-3 rounded-md border border-gray-300 font-medium hover:bg-gray-100"
            >
              <img
