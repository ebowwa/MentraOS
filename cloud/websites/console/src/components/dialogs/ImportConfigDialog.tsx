    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
            ...
            <>
              ...
              <div className="border rounded-lg p-4 bg-gray-50">
                ...
                <div className="space-y-1 text-sm text-gray-600">
                  <div>
                    ...
                    {configData.name
                      ? configData.name
                      : "Not provided (will keep current)"}
                  </div>
                  <div>
              ...
              <div className="space-y-2">
                ...
                <ul className="list-disc list-inside text-sm text-gray-600 space-y-1">
                  ...
                  <li>
                    All current settings will be replaced with{" "}
                    {countSettings(configData.settings)} settings
                  </li>
                  <li>
                    All current tools will be replaced with{" "}
                    {countTools(configData.tools)} tools
                  </li>
                  <li>
                    All current permissions will be replaced with{" "}
                    {countPermissions(configData.permissions)} permissions
                  </li>
                  {hasUrl(configData.publicUrl) && (
                    <li>Server URL will be updated</li>
                  )}
                  {hasUrl(configData.logoURL) && (
                    <li>Logo URL will be updated</li>
                  )}
                  {hasUrl(configData.webviewURL) && (
                    <li>Webview URL will be updated</li>
                  )}
                </ul>
              </div>
            </>
        ...
        <DialogFooter>
          ...
          <Button onClick={onConfirm} disabled={isImporting || !!error}>
            {isImporting ? (
              <>
