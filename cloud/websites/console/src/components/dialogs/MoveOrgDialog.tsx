...
const MoveOrgDialog: React.FC<MoveOrgDialogProps> = ({
  ...
  const currentOrgName =
    eligibleOrgs.find((org) => org.id === currentOrgId)?.name ||
    ...
    try {
      ...
      setError(
        err instanceof Error
          ? err.message
          : "Failed to move app to the selected organization",
      );
    } finally {
      setIsMoving(false);
    }
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Move "{app.name}" from {currentOrgName} to another organization
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="text-sm text-amber-700 bg-amber-50 p-4 rounded-md">
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>
                This action will move the app and all its settings to the
                selected organization.
              </li>
              <li>
                Members of the target organization will gain access to this app.
              </li>
              <li>
                Current organization members will lose access (unless they're
                also in the target organization).
              </li>
