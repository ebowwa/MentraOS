  ...
  const handlePublish = async () => {
    try {
      ...
      if (!currentOrg?.profile?.contactEmail) {
        ...
        setError(
          "Your organization profile is incomplete. Please fill out your organization name and contact email before publishing an app.",
        );
        return;
      }
      ...
      if (
        ...
        error.response.data.error.includes("PROFILE_INCOMPLETE")
      ) {
        setIsProfileIncomplete(true);
        setError(
          "Your organization profile is incomplete. Please fill out your organization name and contact email before publishing an app.",
          ...
          {isProfileIncomplete ? (
            <div className="space-y-4">
              <p className="text-sm text-gray-600">
                Before you can publish your app, you need to complete your
                organization profile. This information will be visible to users
            ...
            <>
              <p className="text-sm text-gray-600 mb-3">
                Publishing your app will make it available for review. Once
                approved, it will be visible to all MentraOS users.
              </p>
              <p className="text-sm text-gray-600">
                Your app will initially be submitted in a{" "}
                <strong>SUBMITTED</strong> state and will need to undergo review
