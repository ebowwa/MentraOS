...
export const metaRayBan: Capabilities = {
  ...
  camera: {
    ...
    video: {
      ...
      // Native SDK delivers 9:16 portrait frames; landscape requires client-side rotation
      supportedResolutions: [
        // Portrait (native from DAT SDK - 9:16 aspect ratio)
        {width: 720, height: 1280, orientation: "portrait"}, // High
        {width: 504, height: 896, orientation: "portrait"}, // Medium
        {width: 360, height: 640, orientation: "portrait"}, // Low
        // Landscape (client-rotated - 16:9 aspect ratio)
        {width: 1280, height: 720, orientation: "landscape"}, // High
        {width: 896, height: 504, orientation: "landscape"}, // Medium
        {width: 640, height: 360, orientation: "landscape"}, // Low
      ],
    },
  },
