...
export class MultiUserAppService {
   ...
   */
  async broadcastToAppUsers(senderSession: UserSession, message: AppBroadcastMessage): Promise<void> {
   ...
   */
  async sendDirectMessage(senderSession: UserSession, message: AppDirectMessage): Promise<boolean> {
